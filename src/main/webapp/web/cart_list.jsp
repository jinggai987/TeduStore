                ...
                <div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="pudcId3">
                            <img src="${pageContext.request.contextPath }${cart.goodsImage}" 
                            	class="lf cart_goods_image"/>
                            <input type="hidden" name="" value="">
                        	<span class="des lf">
                           		${cart.goodsTitle }
                              <input type="hidden" name="" value="">
                        	</span>
                            <p class="col lf" style="display: none;"><span>颜色：</span><span class="color_des">深空灰  <input type="hidden" name="" value=""></span></p>
                        </div>
                    </div>
                    <div class="pices">
